...
colours = ["red".colorize(:red), "blue".colorize(:blue), "yellow".colorize(:yellow), "white".colorize(:white), "black".colorize(:black).on_white, "pink".colorize(:fuchsia), "green".colorize(:green), "purple".colorize(:magenta), "r".colorize(:red) + "a".colorize(:yellow) + "i".colorize(:green) + "n".colorize(:blue) + "b".colorize(:magenta) + "o".colorize(:light_red) + "w".colorize(:cyan)] 
